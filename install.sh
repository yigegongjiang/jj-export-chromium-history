#!/usr/bin/env bash
# Install the latest jj-export-chromium-history binary from GitHub Releases.
# Usage: curl -fsSL https://raw.githubusercontent.com/yigegongjiang/jj-export-chromium-history/main/install.sh | bash

set -euo pipefail

REPO="yigegongjiang/jj-export-chromium-history"
